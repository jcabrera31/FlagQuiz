...
public class QuizActivity extends AppCompatActivity {
     ...
     * Otherwise, it just inflates the standard content_quiz.xml with the fragment_quiz.
     *
    ...
    protected void onStart() {
        ...
        if (preferencesChanged) {
            ...
            QuizActivityFragment quizFragment =
                    (QuizActivityFragment) getFragmentManager().findFragmentById(R.id.quizFragment);
